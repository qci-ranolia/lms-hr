...
var routes = [
    {
        path: '', component: __WEBPACK_IMPORTED_MODULE_3__main_nav_nav_component__["a" /* NavComponent */], children: [
            ...
            { path: '', redirectTo: '/employee-list', pathMatch: 'full', canActivate: [__WEBPACK_IMPORTED_MODULE_11__services_auth_service__["a" /* AuthService */]] },
