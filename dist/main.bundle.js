...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__main_nav_nav_component__ = __webpack_require__("./src/app/main/nav/nav.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__main_dashboard_dashboard_component__ = __webpack_require__("./src/app/main/dashboard/dashboard.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__main_crud_crud_component__ = __webpack_require__("./src/app/main/crud/crud.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__main_crud_add_emp_add_emp_component__ = __webpack_require__("./src/app/main/crud/add-emp/add-emp.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__main_crud_edit_emp_edit_emp_component__ = __webpack_require__("./src/app/main/crud/edit-emp/edit-emp.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__main_eol_eol_component__ = __webpack_require__("./src/app/main/eol/eol.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__main_newapp_newapp_component__ = __webpack_require__("./src/app/main/newapp/newapp.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__main_servererr_servererr_component__ = __webpack_require__("./src/app/main/servererr/servererr.component.ts");
...
var routes = [
    {
        path: '', component: __WEBPACK_IMPORTED_MODULE_3__main_nav_nav_component__["a" /* NavComponent */], children: [
            { path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_4__main_dashboard_dashboard_component__["a" /* DashboardComponent */] },
            { path: '', redirectTo: '/dashboard', pathMatch: 'full', canActivate: [__WEBPACK_IMPORTED_MODULE_11__services_auth_service__["a" /* AuthService */]] },
            { path: 'add-employee', component: __WEBPACK_IMPORTED_MODULE_6__main_crud_add_emp_add_emp_component__["a" /* AddEmpComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_11__services_auth_service__["a" /* AuthService */]] },
            { path: 'employee-list', component: __WEBPACK_IMPORTED_MODULE_5__main_crud_crud_component__["a" /* CrudComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_11__services_auth_service__["a" /* AuthService */]] },
            { path: 'employee-list/:id', component: __WEBPACK_IMPORTED_MODULE_7__main_crud_edit_emp_edit_emp_component__["a" /* EditEmpComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_11__services_auth_service__["a" /* AuthService */]] },
            { path: 'application', component: __WEBPACK_IMPORTED_MODULE_9__main_newapp_newapp_component__["a" /* NewappComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_11__services_auth_service__["a" /* AuthService */]] },
            { path: 'application/:id', component: __WEBPACK_IMPORTED_MODULE_8__main_eol_eol_component__["a" /* EolComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_11__services_auth_service__["a" /* AuthService */]] },
            { path: '404', component: __WEBPACK_IMPORTED_MODULE_10__main_servererr_servererr_component__["a" /* ServererrComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_11__services_auth_service__["a" /* AuthService */]] }
        ]
    },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__main_nav_nav_component__ = __webpack_require__("./src/app/main/nav/nav.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__main_dashboard_dashboard_component__ = __webpack_require__("./src/app/main/dashboard/dashboard.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__main_crud_crud_component__ = __webpack_require__("./src/app/main/crud/crud.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__main_eol_eol_component__ = __webpack_require__("./src/app/main/eol/eol.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__main_newapp_newapp_component__ = __webpack_require__("./src/app/main/newapp/newapp.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__main_stat_stat_component__ = __webpack_require__("./src/app/main/stat/stat.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__main_crud_add_emp_add_emp_component__ = __webpack_require__("./src/app/main/crud/add-emp/add-emp.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__main_crud_edit_emp_edit_emp_component__ = __webpack_require__("./src/app/main/crud/edit-emp/edit-emp.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__services_lms_service__ = __webpack_require__("./src/app/services/lms.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__main_dashboard_piechart_piechart_component__ = __webpack_require__("./src/app/main/dashboard/piechart/piechart.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__main_dashboard_dialog_dialog_component__ = __webpack_require__("./src/app/main/dashboard/dialog/dialog.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25_ngx_pipes__ = __webpack_require__("./node_modules/ngx-pipes/ngx-pipes.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26_ng2_search_filter__ = __webpack_require__("./node_modules/ng2-search-filter/ng2-search-filter.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__main_servererr_servererr_component__ = __webpack_require__("./src/app/main/servererr/servererr.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__main_newapp_appinfo_appinfo_component__ = __webpack_require__("./src/app/main/newapp/appinfo/appinfo.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__main_crud_role_role_component__ = __webpack_require__("./src/app/main/crud/role/role.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__main_dashboard_csv_csv_component__ = __webpack_require__("./src/app/main/dashboard/csv/csv.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__main_crud_empcsv_empcsv_component__ = __webpack_require__("./src/app/main/crud/empcsv/empcsv.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["K" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__main_nav_nav_component__["a" /* NavComponent */],
                __WEBPACK_IMPORTED_MODULE_9__main_dashboard_dashboard_component__["a" /* DashboardComponent */],
                __WEBPACK_IMPORTED_MODULE_10__main_crud_crud_component__["a" /* CrudComponent */],
                __WEBPACK_IMPORTED_MODULE_11__main_eol_eol_component__["a" /* EolComponent */],
                __WEBPACK_IMPORTED_MODULE_12__main_newapp_newapp_component__["a" /* NewappComponent */],
                __WEBPACK_IMPORTED_MODULE_14__login_login_component__["a" /* LoginComponent */],
                __WEBPACK_IMPORTED_MODULE_15__main_stat_stat_component__["a" /* StatComponent */],
                __WEBPACK_IMPORTED_MODULE_16__main_crud_add_emp_add_emp_component__["a" /* AddEmpComponent */],
                __WEBPACK_IMPORTED_MODULE_17__main_crud_edit_emp_edit_emp_component__["a" /* EditEmpComponent */],
                __WEBPACK_IMPORTED_MODULE_23__main_dashboard_piechart_piechart_component__["a" /* PiechartComponent */],
                __WEBPACK_IMPORTED_MODULE_24__main_dashboard_dialog_dialog_component__["a" /* DialogComponent */],
                __WEBPACK_IMPORTED_MODULE_27__main_servererr_servererr_component__["a" /* ServererrComponent */],
                __WEBPACK_IMPORTED_MODULE_28__main_newapp_appinfo_appinfo_component__["a" /* AppinfoComponent */],
                __WEBPACK_IMPORTED_MODULE_29__main_crud_role_role_component__["a" /* RoleComponent */],
                __WEBPACK_IMPORTED_MODULE_30__main_dashboard_csv_csv_component__["a" /* CsvComponent */],
                __WEBPACK_IMPORTED_MODULE_31__main_crud_empcsv_empcsv_component__["a" /* EmpcsvComponent */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_26_ng2_search_filter__["a" /* Ng2SearchPipeModule */],
                __WEBPACK_IMPORTED_MODULE_25_ngx_pipes__["a" /* NgPipesModule */],
                ...
                __WEBPACK_IMPORTED_MODULE_6__angular_router__["c" /* RouterModule */].forRoot(__WEBPACK_IMPORTED_MODULE_13__app_routing_module__["b" /* routes */], { useHash: true })
            ],
...
/***/ "./src/app/main/crud/add-emp/add-emp.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"d-flex justify-content-center\">\n  <div class=\"col-sm-7 pt-2 pb-2\">\n    <h5>Add Employee</h5>\n    <div class=\"col-sm-12 bg-white pt-3 pb-2 d-inline-block rad-box\">\n      <form class=\"example-form\" #userForm=\"ngForm\">\n        <mat-form-field class=\"example-full-width col-sm-2 float-left mb-2\">\n          <input matInput placeholder=\"Qci ID\" [(ngModel)]=\"employee.qci_id\" #qciId=\"ngModel\" required minlength=\"2\" maxlength=\"14\" name=\"qciId\" />\n        </mat-form-field>\n        <mat-form-field class=\"example-full-width col-sm-5 float-left mb-2\">\n          <input matInput placeholder=\"Employee Name\" [(ngModel)]=\"employee.name\" [ngClass]=\"{'is-invalid':name.errors && name.touched}\"\n            #name=\"ngModel\" required minlength=\"5\" maxlength=\"48\" name=\"name\" pattern=\"[a-zA-Z][a-zA-Z ]+\" />\n        </mat-form-field>\n        <mat-form-field class=\"example-full-width col-sm-5 float-left mb-2\">\n          <input matInput placeholder=\"Email\" [(ngModel)]=\"employee.email\" [ngClass]=\"{'is-invalid':email.errors && email.touched}\"\n            name=\"email\" #email=\"ngModel\" required pattern=\"[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\" />\n        </mat-form-field>\n        <mat-form-field class=\"example-full-width col-sm-4 float-left mb-2\">\n          <input matInput placeholder=\"Designation\" [(ngModel)]=\"employee.designation\" [ngClass]=\"{'is-invalid':designation.errors && designation.touched}\"\n            #designation=\"ngModel\" required minlength=\"2\" maxlength=\"48\" pattern=\"[a-zA-Z][a-zA-Z ]+\" name=\"designation\" />\n        </mat-form-field>\n        <mat-form-field class=\"example-full-width col-sm-4 float-left mb-2\">\n          <input matInput placeholder=\"Board\" [(ngModel)]=\"employee.board\" [ngClass]=\"{'is-invalid':board.errors && board.touched}\"\n            #board=\"ngModel\" required minlength=\"2\" maxlength=\"64\" pattern=\"[a-zA-Z][a-zA-Z ]+\" name=\"board\" />\n        </mat-form-field>\n        <mat-form-field class=\"example-full-width col-sm-4 float-left mb-2\">\n          <mat-select placeholder=\"Employee Type\" [(ngModel)]=\"employee.type_of_employee\" (change)=\"gettoe(employee.type_of_employee)\"\n            name=\"type_of_employee\">\n            <mat-option *ngFor=\"let typ of showEmpTyp\" [value]=\"typ.value\">{{typ.value}}</mat-option>\n          </mat-select>\n        </mat-form-field>\n        <mat-form-field class=\"example-full-width col-sm-3 float-left mb-2\">\n          <mat-select placeholder=\"Select Gender\" [(ngModel)]=\"employee.gender\" (change)=\"getGender(employee.gender)\"\n            name=\"gender\">\n            <mat-option *ngFor=\"let gndr of showGender\" [value]=\"gndr.value\">{{gndr.value}}</mat-option>\n          </mat-select>\n        </mat-form-field>\n        <mat-form-field class=\"example-full-width col-sm-6 float-left mb-2\">\n          <input matInput placeholder=\"Reporting Manager\" [(ngModel)]=\"employee.reporting_manager\" [ngClass]=\"{'is-invalid':reportingManager.errors && reportingManager.touched}\"\n            #reportingManager=\"ngModel\" required minlength=\"2\" maxlength=\"14\" name=\"reportingManager\" />\n        </mat-form-field>\n        <mat-form-field class=\"example-full-width col-sm-3 float-left mb-2\">\n          <input matInput placeholder=\"Date of Joining\" [matDatepicker]=\"firstDate\" (dateInput)=\"firstDateEvent($event)\"><!-- [min]=\"minDate\" [matDatepickerFilter]=\"disableSunDay\" (dateInput)=\"firstDateEvent($event)\" formControlName=\"check1\"-->\n          <mat-datepicker-toggle matSuffix [for]=\"firstDate\"></mat-datepicker-toggle>\n          <mat-datepicker #firstDate></mat-datepicker>\n        </mat-form-field>\n        <mat-form-field class=\"example-full-width col-sm-8 float-left mb-2\">\n          <input matInput placeholder=\"Password\" [type]=\"sp.checked ? 'text' : 'password'\" [(ngModel)]=\"employee.password\"\n            name=\"password\" />\n        </mat-form-field>\n        <mat-checkbox class=\"example-full-width col-sm-4 float-left mt-3\" #sp color=\"primary\">Show password</mat-checkbox>\n        <div class=\"clearfix\"></div>\n        <button mat-button class=\"ml-3 mt-3 btn btn-primary p-2\" [disabled]=\"!userForm.form.valid\" (click)=\"addEmployee(userForm)\">Add\n          Employee</button>\n      </form>\n    </div>\n  </div>\n</div>\n"

/***/ }),

/***/ "./src/app/main/crud/add-emp/add-emp.component.scss":
/***/ (function(module, exports) {
...
/***/ "./src/app/main/crud/add-emp/add-emp.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var AddEmpComponent = /** @class */ (function () {
    ...
    AddEmpComponent.prototype.getGender = function (item) {
        this.gender = item;
        if (this.gender == 'Male') {
            this.hide = true;
            this.show = false;
    ...
    AddEmpComponent.prototype.firstDateEvent = function (event) {
    ...
    AddEmpComponent.prototype.ngOnDestroy = function () {
...
module.exports = "<div class=\"col-sm-12 p-0\">\n  <div class=\"col-sm-12 float-left\">\n    <h5 class=\"d-inline-block\">Employee's List</h5>\n    <div class=\"d-inline-block float-right\">\n      <!-- <button mat-button class=\"btn p-2 mat-button mt-0 mb-3\" [routerLink]=\"['/add-employee']\">Add Employee</button> -->\n      <!-- <button mat-button class=\"btn btn-primary p-2 mat-button mt-0 mb-3\" (click)=\"assignRole()\">Add Role</button> -->\n      <!-- [routerLink]=\"['/add-employee']\"-->\n      <button mat-raised-button class=\"btn btn-primary p-2 mat-button mt-0 mb-3\" (click)=\"openUploadDialog($event)\">Upload employee excel</button>\n    </div>\n    <div class=\"col-sm-12 bg-white pt-3 pb-2 d-inline-block rad-box\">\n      <table id=\"table_id\" class=\"table table-striped\" cellspacing=\"0\" width=\"100%\">\n        <thead>\n          <tr>\n            <th class=\"wd-7\">QCID</th>\n            <th class=\"wd-14\">Employee's Info</th>\n            <th class=\"wd-14\">Reporting Manager</th>\n            \n            <th class=\"tableInside wd-59 pb-0\">\n              <table class=\"col-sm-12 tableInside\">\n                <tr class=\"bg-white\">\n                  <th class=\"ss bs\" :matTooltip=\"Type Of Leave\">TOL</th>\n                  <th class=\"ss bs\" :matTooltip=\"Opening Balance\">OB</th>\n                  <th class=\"ss bs\" :matTooltip=\"Credit in advance for the year\">CA</th>\n                  <th class=\"ss bs\" :matTooltip=\"Total Leave\">TL</th>\n      \n                  <th class=\"ss\" :matTooltip=\"January\">Jan</th>\n                  <th class=\"ss\" :matTooltip=\"February\">Feb</th>\n                  <th class=\"ss\" :matTooltip=\"March\">Mar</th>\n                  <th class=\"ss\" :matTooltip=\"April\">Apr</th>\n                  <th class=\"ss\" :matTooltip=\"May\">May</th>\n                  <th class=\"ss\" :matTooltip=\"June\">Jun</th>\n                  <th class=\"ss\" :matTooltip=\"July\">Jul</th>\n                  <th class=\"ss\" :matTooltip=\"August\">Aug</th>\n                  <th class=\"ss\" :matTooltip=\"September\">Sep</th>\n                  <th class=\"ss\" :matTooltip=\"October\">Oct</th>\n                  <th class=\"ss\" :matTooltip=\"November\">Nov</th>\n                  <th class=\"ss\" :matTooltip=\"December\">Dec</th>\n      \n                  <th class=\"ss bs\" :matTooltip=\"Availed Leave\">AL</th>\n                  <th class=\"ss bs\" :matTooltip=\"Closing Balance\">CB</th>\n                <tr>\n              </table>\n            </th>\n            <!-- <th class=\"modify\">Modify</th> -->\n          </tr>\n        </thead>\n        <tbody>\n          <tr *ngFor=\"let emp of emplCSV; let i = index\">\n            <!--\n              Date_of_joining\n              Email_ID\n              Gender\n              ID_Code\n              Nature_of_appointment\n              Officials\n              QCI/board\n              RO_mail\n              RO\n            -->\n            <td class=\"wd-7\">{{emp.ID_code}}</td>\n            <td class=\"wd-14\">\n              <strong :matTooltip=\"{{emp['Email_ID']}}\">{{emp[\"Officials\"]}}</strong><br />\n              <small>{{emp.Nature_of_Appointment}}</small><small class=\"text-primary\">( {{emp[\"QCI/Board\"]}} )</small>\n            </td>\n            <td class=\"wd-14\">{{emp.Reporting_Officer}}</td>\n\n            <td class=\"tableInside wd-59\">\n              <table class=\"col-sm-12\">\n                <tr *ngFor=\"let type of emp._type; let j = index\">\n                  <td class=\"ss bs\">{{type.leave_type}}</td>\n                  <td class=\"ss bs\">{{type[\"Opening_bal(1jan18)\"]}}</td>\n                  <td class=\"ss bs\">{{type.Credit_in_advance_for_the_year}}</td>\n                  <td class=\"ss bs\">{{type.total_leave}}</td>\n\n                  <td class=\"ss\">{{type.Jan}}</td>\n                  <td class=\"ss\">{{type.Feb}}</td>\n                  <td class=\"ss\">{{type.Mar}}</td>\n                  <td class=\"ss\">{{type.Apr}}</td>\n                  <td class=\"ss\">{{type.May}}</td>\n                  <td class=\"ss\">{{type.Jun}}</td>\n                  <td class=\"ss\">{{type.Jul}}</td>\n                  <td class=\"ss\">{{type.Aug}}</td>\n                  <td class=\"ss\">{{type.Sep}}</td>\n                  <td class=\"ss\">{{type.Oct}}</td>\n                  <td class=\"ss\">{{type.Nov}}</td>\n                  <td class=\"ss\">{{type.Dec}}</td>\n\n                  <td class=\"ss bs\">{{type.Apr}}</td>\n                  <td class=\"ss bs\">{{type.bal_leave}}</td>\n                </tr>\n              </table>\n            </td>\n            <!-- <td class=\"modify\">\n              <i class=\"fa fa-pencil-square-o\" aria-hidden=\"true\" :routerLink=\"/employee-list/{{emp.ID_code}}\"></i>\n              <i class=\"fa fa-times\" aria-hidden=\"true\" (click)=\"deleteEmp(emp.ID_code)\"></i>\n            </td> -->\n          </tr>\n        </tbody>\n      </table>\n    </div>\n  </div>\n</div>"

/***/ }),

/***/ "./src/app/main/crud/crud.component.scss":
/***/ (function(module, exports) {

module.exports = "table tr td .fa {\n  margin: 0px 3px;\n  padding: 4px 5px 2px;\n  font-size: 13px;\n  position: relative;\n  top: -3px;\n  border-radius: 20px;\n  -webkit-transition: all 150ms ease 25ms;\n  transition: all 150ms ease 25ms;\n  opacity: 1;\n  line-height: 16px;\n  cursor: pointer;\n  border: 1px solid #c4c4c4;\n  color: #0c7cd5; }\n\n.table > tbody > tr {\n  border: none; }\n\n.table > tbody > tr > td {\n  padding: 8px;\n  -webkit-box-sizing: border-box;\n          box-sizing: border-box; }\n\n.table > thead > tr > th.modify {\n  width: 4% !important; }\n\ntable.tableInside > thead > tr > th.ss, .tableInside table > tbody > tr > td.ss {\n  border-right: 1px solid #ccc;\n  -webkit-box-sizing: border-box;\n          box-sizing: border-box;\n  padding: 0;\n  width: 5.5%;\n  text-align: center;\n  font-size: 0.85rem;\n  border-top: none;\n  border-bottom: none; }\n\ntable.dataTable thead .sorting {\n  background-image: none; }\n"

/***/ }),

/***/ "./src/app/main/crud/crud.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_lms_service__ = __webpack_require__("./src/app/services/lms.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_api_service__ = __webpack_require__("./src/app/services/api.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__role_role_component__ = __webpack_require__("./src/app/main/crud/role/role.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_material__ = __webpack_require__("./node_modules/@angular/material/esm5/material.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__empcsv_empcsv_component__ = __webpack_require__("./src/app/main/crud/empcsv/empcsv.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CrudComponent = /** @class */ (function () {
    function CrudComponent(lms, api, dialog) {
        var _this = this;
        this.lms = lms;
        this.api = api;
        this.dialog = dialog;
        ...
        this.employeeCSV = new Array; // new array made by me due to lack of experts
    ...
    CrudComponent.prototype.openUploadDialog = function ($e) {
        $e.stopPropagation();
        var dialogRef = this.dialog.open(__WEBPACK_IMPORTED_MODULE_5__empcsv_empcsv_component__["a" /* EmpcsvComponent */], { width: "50%", height: "50%" });
    };
    CrudComponent.prototype.assignRole = function () {
        this.dialog.open(__WEBPACK_IMPORTED_MODULE_3__role_role_component__["a" /* RoleComponent */], {
            width: "60%",
            height: "75%",
        });
    };
    ...
    CrudComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_lms_service__["a" /* LmsService */], __WEBPACK_IMPORTED_MODULE_2__services_api_service__["a" /* ApiService */], __WEBPACK_IMPORTED_MODULE_4__angular_material__["i" /* MatDialog */]])
    ], CrudComponent);
...
/***/ "./src/app/main/crud/edit-emp/edit-emp.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"d-flex justify-content-center\">\n  <div class=\"col-sm-7 pt-2 pb-2\">\n    <h5>Edit Employee</h5>\n    <div class=\"col-sm-12 bg-white pt-3 pb-2 d-inline-block rad-box\">\n      <form class=\"example-form\">\n        <mat-form-field class=\"example-full-width col-sm-2 float-left mb-2\">\n          <input matInput placeholder=\"Qci ID\" [(ngModel)]=\"employee.qci_id\" name=\"qci_id\" disabled />\n        </mat-form-field>\n        <mat-form-field class=\"example-full-width col-sm-5 float-left mb-2\">\n          <input matInput placeholder=\"Employee Name\" [(ngModel)]=\"employee.name\" name=\"name\" />\n        </mat-form-field>\n        <mat-form-field class=\"example-full-width col-sm-5 float-left mb-2\">\n          <input matInput placeholder=\"Email\" [(ngModel)]=\"employee.email\" name=\"email\" />\n        </mat-form-field>\n        <mat-form-field class=\"example-full-width col-sm-4 float-left mb-2\">\n          <input matInput placeholder=\"Designation\" [(ngModel)]=\"employee.designation\" name=\"designation\" />\n        </mat-form-field>\n        <mat-form-field class=\"example-full-width col-sm-4 float-left mb-2\">\n          <input matInput placeholder=\"Board\" [(ngModel)]=\"employee.board\" name=\"board\" />\n        </mat-form-field>\n        <mat-form-field class=\"example-full-width col-sm-4 float-left mb-2\">\n          <input matInput placeholder=\"Employee Type\" [(ngModel)]=\"employee.type_of_employee\" name=\"type_of_employee\" />\n        </mat-form-field>\n        <mat-form-field class=\"example-full-width col-sm-3 float-left mb-2\">\n          <input matInput placeholder=\"Gender\" [(ngModel)]=\"employee.gender\" name=\"gender\" />\n        </mat-form-field>\n        <mat-form-field class=\"example-full-width col-sm-6 float-left mb-2\">\n          <input matInput placeholder=\"Reporting Manager\" [(ngModel)]=\"employee.reporting_manager\" name=\"reportingManager\" />\n        </mat-form-field>\n        <br />\n        <button mat-button class=\"ml-3 mt-3 btn btn-primary p-2\" (click)=\"updateEmployee()\">Update Employee</button>\n      </form>\n    </div>\n  </div>\n</div>\n<!--\n  <div class=\"d-flex justify-content-center\">\n    <div class=\"col-sm-7 pt-2 pb-2\">\n      <h5>Edit Employee</h5>\n      <div class=\"col-sm-12 bg-white pt-3 pb-2 d-inline-block rad-box\">\n        <form class=\"example-form\">\n          <mat-form-field class=\"example-full-width col-sm-2 float-left mb-2\">\n            <input matInput placeholder=\"Qci ID\" [(ngModel)]=\"employee.ID_code\" name=\"qci_id\" disabled />\n          </mat-form-field>\n          <mat-form-field class=\"example-full-width col-sm-5 float-left mb-2\">\n            <input matInput placeholder=\"Employee Name\" [(ngModel)]=\"employee.Officials\" name=\"name\" />\n          </mat-form-field>\n          <mat-form-field class=\"example-full-width col-sm-5 float-left mb-2\">\n            <input matInput placeholder=\"Email\" [(ngModel)]=\"employee.Email-ID\" name=\"email\" />\n          </mat-form-field>\n          <mat-form-field class=\"example-full-width col-sm-4 float-left mb-2\">\n            <input matInput placeholder=\"Board\" [(ngModel)]=\"employee['QCI/Board']\" name=\"board\" />\n          </mat-form-field>\n          <mat-form-field class=\"example-full-width col-sm-4 float-left mb-2\">\n            <input matInput placeholder=\"Employee Type\" [(ngModel)]=\"employee.Nature_of_Appointment\" name=\"Nature_of_Appointment\" />\n          </mat-form-field>\n          <mat-form-field class=\"example-full-width col-sm-6 float-left mb-2\">\n            <input matInput placeholder=\"Reporting Manager\" [(ngModel)]=\"employee.Reporting_Officer\" name=\"reportingManager\" />\n          </mat-form-field>\n          <br />\n          <button mat-button class=\"ml-3 mt-3 btn btn-primary p-2\" (click)=\"updateEmployee()\">Update Employee</button>\n        </form>\n      </div>\n    </div>\n  </div>\n -->"

/***/ }),

/***/ "./src/app/main/crud/edit-emp/edit-emp.component.scss":
/***/ (function(module, exports) {
...
/***/ "./src/app/main/crud/edit-emp/edit-emp.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EditEmpComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
...
/***/ "./src/app/main/crud/empcsv/empcsv.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EmpcsvComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_material__ = __webpack_require__("./node_modules/@angular/material/esm5/material.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_api_service__ = __webpack_require__("./src/app/services/api.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_observable_forkJoin__ = __webpack_require__("./node_modules/rxjs/_esm5/observable/forkJoin.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_lms_service__ = __webpack_require__("./src/app/services/lms.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EmpcsvComponent = /** @class */ (function () {
    function EmpcsvComponent(dialogRef, lms, api) {
    ...
    EmpcsvComponent.prototype.ngOnInit = function () { };
    EmpcsvComponent.prototype.addFiles = function () {
        this.file.nativeElement.click();
    };
    EmpcsvComponent.prototype.onFilesAdded = function () {
    ...
    EmpcsvComponent.prototype.closeDialog = function () {
        var _this = this;
        ...
        Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_observable_forkJoin__["a" /* forkJoin */])(allProgressObservables).subscribe(function (end) {
    ...
    ], EmpcsvComponent.prototype, "file", void 0);
    EmpcsvComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-empcsv',
            template: __webpack_require__("./src/app/main/crud/empcsv/empcsv.component.html"),
            styles: [__webpack_require__("./src/app/main/crud/empcsv/empcsv.component.scss")]
        }),
...
/***/ "./src/app/main/crud/role/role.component.html":
/***/ (function(module, exports) {
...
/***/ "./src/app/main/crud/role/role.component.scss":
/***/ (function(module, exports) {
...
/***/ "./src/app/main/crud/role/role.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var RoleComponent = /** @class */ (function () {
    ...
    RoleComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-role',
            template: __webpack_require__("./src/app/main/crud/role/role.component.html"),
            styles: [__webpack_require__("./src/app/main/crud/role/role.component.scss")]
        }),
...
/***/ "./src/app/main/dashboard/csv/csv.component.html":
/***/ (function(module, exports) {
...
/***/ "./src/app/main/dashboard/csv/csv.component.scss":
/***/ (function(module, exports) {
...
/***/ "./src/app/main/dashboard/csv/csv.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var CsvComponent = /** @class */ (function () {
        ...
        this.unsubGetHoliday = this.api.emitgetHoliday.subscribe(function (el) {
            setTimeout(function () {
                ...
                if (m < 9)
                    ...
                    m++ && (_this.month = m);
                var today = String(_this.tDate + "/" + _this.month + "/" + _this.year);
            ...
            localStorage.setItem('holidays', _this.holidays);
        });
    }
    ...
    CsvComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-csv',
            template: __webpack_require__("./src/app/main/dashboard/csv/csv.component.html"),
            styles: [__webpack_require__("./src/app/main/dashboard/csv/csv.component.scss")]
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__dialog_dialog_component__ = __webpack_require__("./src/app/main/dashboard/dialog/dialog.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__csv_csv_component__ = __webpack_require__("./src/app/main/dashboard/csv/csv.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_lms_service__ = __webpack_require__("./src/app/services/lms.service.ts");
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(dialog, api, lms) {
        var _this = this;
        this.dialog = dialog;
        this.api = api;
        this.lms = lms;
        ...
        this.employee = new Array();
        this.emp = new Array();
        this.empApplications = new Array();
        this.items = new Array();
        this.holidays = new Array();
        this.Contract = new Array;
        this.Regular = new Array;
        this.Professional = new Array;
        this.compulsory = [];
        this.combineDateEmp = [];
        this.offDays = [];
        // page loader
        ...
        var dd = tmp.getDate(), mm = tmp.getMonth() + 1, yyyy = tmp.getFullYear();
        if (dd < 10)
            dd = "0" + dd;
        if (mm < 10)
            mm = "0" + mm;
        ...
        this.unsubGetEmployees = this.lms.emitgetEmployees.subscribe(function (r) {
            ...
            for (var i = 0; i < r.length; i++) {
                switch (r[i].type_of_employee) {
                    case "Contract":
                        _this.Contract.push(r[i]);
                        break;
                    case "Professional":
                        _this.Professional.push(r[i]);
                        break;
                    case "Regular":
                        _this.Regular.push(r[i]);
                }
            }
        });
        this.unsubEmployeesOnLeave = this.lms.emitEOL.subscribe(function (r) {
            _this.applications = r;
        });
        ...
        this.unsubCount = this.api.emitCount.subscribe(function (r) {
            ...
            var t = x, s = y;
            if (!(_this.combineDateEmp.length >= 1)) {
                for (var i = 0; i < _this.daysArr.length; i++) {
                    ...
                    if (!(x[i] == _this.totalDaysOfMonth[i]))
                        t.splice(i, 0, _this.totalDaysOfMonth[i]), s.splice(i, 0, 0);
                    // create new array of the response from the server which includes holidays too
                    _this.combineDateEmp.push({ day: _this.daysArr[i], count: s[i] });
                }
            }
        });
    }
    // CSV Dialog
    DashboardComponent.prototype.openUploadDialog = function ($e) {
        $e.stopPropagation();
        var dialogRef = this.dialog.open(__WEBPACK_IMPORTED_MODULE_3__dialog_dialog_component__["a" /* DialogComponent */], { width: "50%", height: "50%" });
    };
    DashboardComponent.prototype.openCSV = function ($e) {
        $e.stopPropagation();
        var dialogRef = this.dialog.open(__WEBPACK_IMPORTED_MODULE_4__csv_csv_component__["a" /* CsvComponent */], { width: "50%", height: "85%" });
    };
    ...
    DashboardComponent.prototype.getEmpOnLeave = function (data) {
        if (!data.count)
            this.emp = [];
        this.getMonth = this.date.format("MM/YYYY");
        this.postDate = data.day;
        var temp = this.postDate + "/" + this.getMonth;
        this.api.getEmpOnLeave(temp);
    };
    DashboardComponent.prototype.todayCheck = function (day) {
        if (!day)
            return false;
        return __WEBPACK_IMPORTED_MODULE_2_moment__().format("L") === day.format;
    };
    DashboardComponent.prototype.createCalendar = function (month) {
        var _this = this;
        this.combineDateEmp = [];
        this.daysArr = this.combineDateEmp;
        var f = __WEBPACK_IMPORTED_MODULE_2_moment__(month).startOf("M"), s = __WEBPACK_IMPORTED_MODULE_2_moment__(f).endOf("month"), sunday = 0, r = [], c = f.clone(), h = [], z = [], y, // m : number,
        temp = []; // , dates = []
        // Find sundays in a month
        while (c.day(7 + sunday).isBefore(s))
            r.push(c.clone().format("DD/MM/YYYY"));
        // Calculate leavedays
        var td = s.diff(f, "days") + 1; // What is td( totalDays ) ?????
        ...
        f = __WEBPACK_IMPORTED_MODULE_2_moment__(month).startOf('M');
        ...
        setTimeout(function () {
            ...
            _this.compulsory.map(function (e) { return h.push(e["Date"]); });
            ...
            _this.workingDays = temp.filter(function (k) {
                // Find total holidays in "DD" format for styling
                if (x.indexOf(k) >= 0)
                    (y = k.split("/").reverse().join("").slice(-2)), z.push(y);
    ...
    DashboardComponent.prototype.previousMonth = function () {
        this.date.subtract(1, "M");
        this.cmnProgram();
    };
    DashboardComponent.prototype.cmnProgram = function () {
        this.daysArr = this.createCalendar(this.date);
        if (!this.postDate)
            this.getMonth = this.date.format("DD/MM/YYYY"); // Next Month
        else
            this.getMonth = this.date.format(this.postDate + "/" + "MM/YYYY"); // Prev Month
    };
    ...
    DashboardComponent = __decorate([
        ...
        ,
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_material__["i" /* MatDialog */], __WEBPACK_IMPORTED_MODULE_6__services_api_service__["a" /* ApiService */], __WEBPACK_IMPORTED_MODULE_5__services_lms_service__["a" /* LmsService */]])
    ], DashboardComponent);
...
/***/ "./src/app/main/dashboard/dialog/dialog.component.html":
/***/ (function(module, exports) {

module.exports = "<input type=\"file\" #file style=\"display: none\" (change)=\"onFilesAdded()\" multiple />\n<div class=\"container\" fxLayout=\"column\" fxLayoutAlign=\"space-evenly stretch\">\n  <h1 mat-dialog-title class=\"mb-0\">\n    Upload Files<small class=\"text-muted\"> (You can add multiple files) </small>\n    <button [disabled]=\"uploading || uploadSuccessful\" mat-raised-button color=\"primary\" class=\"add-files-btn mt-3\" (click)=\"addFiles()\">Add Files</button>\n  </h1>\n  <strong class=\"text-muted\"><small>Note: Kindly add restricted holiday CSV file first</small></strong>\n  <hr />\n  <mat-dialog-content fxFlex class=\"col-sm-12 m-0 p-0\" style=\"flex:1 1 auto;box-sizing:border-box;height:20vh\">\n    <mat-list>\n      <mat-list-item *ngFor=\"let file of files; let i = index\">\n        <h4 mat-line>{{file.name}}</h4>\n        <mat-progress-bar class=\"col-sm-8\" *ngIf=\"progress\" mode=\"determinate\" [value]=\"progress[file.name].progress | async\"></mat-progress-bar>\n      </mat-list-item>\n    </mat-list>\n  </mat-dialog-content>\n  <mat-dialog-actions class=\"actions\">\n    <button *ngIf=\"showCancelButton\" mat-button mat-dialog-close>Cancel</button>\n    <button mat-raised-button color=\"primary\" [disabled]=\"!canBeClosed\" (click)=\"closeDialog()\">{{primaryButtonText}}</button>\n  </mat-dialog-actions>\n</div>"

/***/ }),

/***/ "./src/app/main/dashboard/dialog/dialog.component.scss":
/***/ (function(module, exports) {
...
/***/ "./src/app/main/dashboard/dialog/dialog.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var DialogComponent = /** @class */ (function () {
    function DialogComponent(dialogRef, lms, api) {
        this.dialogRef = dialogRef;
        this.lms = lms;
        this.api = api;
        this.files = new Set();
...
/***/ "./src/app/main/dashboard/piechart/piechart.component.html":
/***/ (function(module, exports) {

module.exports = "<!-- <div class=\"rad-box\" id=\"{{elementId}}\" ></div> -->\n<div class=\"col-sm-6 float-left pl-0\">\n    <div class=\"rad-box mb-2 bg-white p-4\">\n        <canvas id=\"bar\">{{ bar }}</canvas>\n    </div>\n</div>\n<div class=\"col-sm-6 float-left pr-0\">\n    <div class=\"rad-box mb-2 bg-white p-4\">\n        <canvas id=\"polarArea\">{{ polarArea }}</canvas>\n    </div>\n</div>\n<!-- <div class=\"col-sm-4 float-left pl-0\">\n    <div class=\"rad-box mb-2 bg-white p-4\">\n        <canvas id=\"line\">{{ line }}</canvas>\n    </div>\n</div> -->"

/***/ }),

/***/ "./src/app/main/dashboard/piechart/piechart.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var PiechartComponent = /** @class */ (function () {
    function PiechartComponent(lms) {
        var _this = this;
        this.lms = lms;
        this.boards = [];
        this.boardEmp = [];
        this.gender = [];
        this.genderCount = [];
        this.unsubGetEmployees = this.lms.emitgetEmployees.subscribe(function (el) {
            // console.log(el)
            ...
            for (var i = 0; i < tmpBoard.length; i++) {
                if (tmpBoard[i] != bcurrent) {
                    if (bcnt > 0)
                        _this.boards.push(bcurrent) && _this.boardEmp.push(bcnt);
            ...
            for (var i = 0; i < tmpMF.length; i++) {
                if (tmpMF[i] != gcurrent) {
                    if (gcnt > 0)
                        _this.gender.push(gcurrent) && _this.genderCount.push(gcnt);
    ...
    PiechartComponent.prototype.ngOnInit = function () {
        var _this = this;
        setTimeout(function () {
            _this.bar = new __WEBPACK_IMPORTED_MODULE_2_chart_js__["Chart"]('bar', {
                type: 'bar',
                data: {
                    labels: _this.boards,
                    datasets: [{
                            data: _this.boardEmp,
                            backgroundColor: [
                                'rgba(155, 199, 172, 0.7)', 'rgba(54, 162, 235, 0.7)', 'rgba(255, 206, 86, 0.7)', 'rgba(205, 106, 186, 0.7)'
                            ],
                            borderColor: [
                                'rgba(155,199,172,1)', 'rgba(54, 162, 235, 1)', 'rgba(255, 206, 86, 1)', 'rgba(205, 106, 186, 0.5)'
                            ], borderWidth: 2
                        }]
                },
                options: {
            ...
            _this.polarArea = new __WEBPACK_IMPORTED_MODULE_2_chart_js__["Chart"]('polarArea', {
                type: 'polarArea',
                data: {
                    labels: _this.gender,
                    datasets: [{
                            data: _this.genderCount,
                            backgroundColor: [
    ...
    PiechartComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'pie-chart',
            template: __webpack_require__("./src/app/main/dashboard/piechart/piechart.component.html")
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_lms_service__["a" /* LmsService */]])
    ], PiechartComponent);
...
var EolComponent = /** @class */ (function () {
    function EolComponent(route, api, lms) {
        var _this = this;
        this.route = route;
        this.api = api;
        this.lms = lms;
        ...
        this.unsubLoader = this.lms.emitsload.subscribe(function (el) { return _this.loader = el; });
        this.lms.showLoader();
        this.unsubGetEmployee = this.api.emitgetEmployee.subscribe(function (r) { return _this.employee = r; });
    ...
    EolComponent.prototype.ngOnInit = function () {
        this.api.getEmployee(this.uid);
        this.api.myLeaves(this.uid);
    };
    EolComponent.prototype.ngOnDestroy = function () {
        this.unsubLoader.unsubscribe();
        this.unsubGetEmployee.unsubscribe();
        this.unsubMyLeaves.unsubscribe();
        this.unsubZeroLeaves.unsubscribe();
    };
    EolComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-eol',
            template: __webpack_require__("./src/app/main/eol/eol.component.html"),
            styles: [__webpack_require__("./src/app/main/eol/eol.component.scss")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */], __WEBPACK_IMPORTED_MODULE_3__services_api_service__["a" /* ApiService */], __WEBPACK_IMPORTED_MODULE_2__services_lms_service__["a" /* LmsService */]])
    ], EolComponent);
    return EolComponent;
}());
...
module.exports = "<mat-toolbar color=\"primary\" class=\"sticky-top\">\n  <mat-toolbar-row>\n    <div class=\"col-sm-5\">\n      <span class=\"pl-3 pr-3 bg-white text-dark\">QCI | LMS</span>\n      <span class=\"pl-3 pr-3\" routerLinkActive=\"active\" [routerLink]=\"['/dashboard']\">Home</span>\n      <span class=\"pl-3 pr-3\" routerLinkActive=\"active\" [routerLink]=\"['/application']\">Applications</span>\n      <span class=\"pl-3 pr-3\" routerLinkActive=\"active\" [routerLink]=\"['/employee-list']\">Employees</span>\n      <!-- <span class=\"pl-3 pr-3\" routerLinkActive=\"active\" [routerLink]=\"['/application-status']\">Employees on leave</span> -->\n    </div>\n    <div class=\"col-sm-7 float-right text-right p-0\">\n      <mat-menu #appMenu=\"matMenu\" yPosition=\"above\">\n        <button mat-menu-item (click)=\"logout()\">Logout</button>\n      </mat-menu>\n      <button mat-icon-button [matMenuTriggerFor]=\"appMenu\">\n        <mat-icon>more_vert</mat-icon>\n      </button>\n    </div>\n  </mat-toolbar-row>\n</mat-toolbar>\n<br />\n<div class=\"col-md-12 pos-rel p-0\">\n  <router-outlet></router-outlet>\n</div>"
...
var NavComponent = /** @class */ (function () {
    ...
    NavComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-nav',
            template: __webpack_require__("./src/app/main/nav/nav.component.html"),
            styles: [__webpack_require__("./src/app/main/nav/nav.component.scss")]
        }),
...
var AppinfoComponent = /** @class */ (function () {
    ...
    AppinfoComponent.prototype.ngOnInit = function () {
        ...
        this.firstFormGroup = this._formBuilder.group({
            check1: ["", __WEBPACK_IMPORTED_MODULE_6__angular_forms__["j" /* Validators */].required],
            check2: ["", __WEBPACK_IMPORTED_MODULE_6__angular_forms__["j" /* Validators */].required]
        });
        this.secondFormGroup = this._formBuilder.group({
            check3: ["", __WEBPACK_IMPORTED_MODULE_6__angular_forms__["j" /* Validators */].required],
            check4: ["", __WEBPACK_IMPORTED_MODULE_6__angular_forms__["j" /* Validators */].required]
        });
        /*from employee close*/
    };
    ...
    AppinfoComponent.prototype.letDateConditions = function () {
        ...
        for (var i = 0; i < this.leave.length; i++) {
            if (this.leave[i].leave_status !== "Rejected") {
                ...
                var x = this.leave[i].date_from.split("/"), y = x[1] + '/' + x[0] + '/' + x[2], f = __WEBPACK_IMPORTED_MODULE_5_moment__(y), s = this.leave[i].date_to, arr = [];
    ...
    AppinfoComponent.prototype.countSundays = function () {
        ...
        var f = __WEBPACK_IMPORTED_MODULE_5_moment__(this.firstDate), s = __WEBPACK_IMPORTED_MODULE_5_moment__(this.secondDate), sunday = 0, r = [], c = f.clone(), temp = [];
        ...
        f = __WEBPACK_IMPORTED_MODULE_5_moment__(this.firstDate);
        // Find all sunday/'s
        while (c.day(7 + sunday).isBefore(s))
            r.push(c.clone());
        this.sundays = r;
    ...
    AppinfoComponent.prototype.declineApp = function (dec_reason, app_ids) {
        var _this = this;
        var date = __WEBPACK_IMPORTED_MODULE_5_moment__().format("DD/MM/YYYY");
    ...
    AppinfoComponent = __decorate([
        ...
        __metadata("design:paramtypes", [Object, __WEBPACK_IMPORTED_MODULE_1__angular_common__["d" /* DatePipe */],
            __WEBPACK_IMPORTED_MODULE_2__angular_material__["k" /* MatDialogRef */],
            __WEBPACK_IMPORTED_MODULE_4__services_lms_service__["a" /* LmsService */],
...
module.exports = "<div class=\"col-sm-12 mt-5 pt-5 justify-content-center\" style=\"display:none\">\n  <div class=\"text-center mt-5 pt-5\">No application found...</div>\n</div>\n<div class=\"col-sm-12 p-0\">\n  <div class=\"col-sm-12 float-left na\">\n    <mat-tab-group (selectedTabChange)=\"whichApplication($event)\">\n      <mat-tab label=\"New Applications\">\n        <div class=\"col-sm-12 bg-white pt-3 pb-2 d-inline-block rad-box\">\n          <table id=\"table_new\" class=\"table table-striped\" cellspacing=\"0\" width=\"100%\">\n            <thead>\n              <tr>\n                <th class=\"wd-12\">Application ID</th>\n                <th class=\"wd-16\">Employee name</th>\n                <th class=\"wd-15\">QCI/Board</th>\n                <th class=\"wd-15\">Leave Type</th>\n                <th class=\"wd-16\">Date Applied</th>\n                <th class=\"wd-16\">Application Date</th>\n                <th class=\"modify\">Actions</th>\n              </tr>\n            </thead>\n            <tbody>\n              <tr *ngFor=\"let app of application | reverse | filter : term; let i = index;\">\n                <td class=\"wd-7\">\n                  <a href=\"javascript:void(0)\" class=\"text-primary\" (click)=\"appInfo(app.application_id, app.ID_code)\">\n                    <u>{{app.application_id | slice:0:12 }}</u>\n                  </a>\n                </td>\n                <td class=\"wd-16\">\n                  <span :matTooltip=\"{{app.email}}\">{{app.Officials}}</span>\n                </td>\n                <td class=\"wd-15\">\n                  <span :matTooltip=\"{{app['QCI/Board']}}\">{{app['QCI/Board']}}</span>\n                </td>\n                <td>{{app.leave_type}}</td>\n                <!-- \n                <td class=\"wd-15\" *ngIf=\"app.leave_type == 'ptl'\">\n                  <span :matTooltip=\"{{app.leave_reason}}\">Paterinity Leave</span>\n                </td>\n                <td class=\"wd-15\" *ngIf=\"app.leave_type == 'cl'\">\n                  <span :matTooltip=\"{{app.leave_reason}}\">Casual Leave</span>\n                </td>\n                <td class=\"wd-15\" *ngIf=\"app.leave_type == 'pl'\">\n                  <span :matTooltip=\"{{app.leave_reason}}\">Privileged Leave</span>\n                </td>\n                <td class=\"wd-15\" *ngIf=\"app.leave_type == 'sl'\">\n                  <span :matTooltip=\"{{app.leave_reason}}\">Sick Leave</span>\n                </td> \n                <td class=\"wd-15\" *ngIf=\"app.leave_type == 'eol'\">\n                  <span :matTooltip=\"{{app.leave_reason}}\">Extra Ordinary Leave</span>\n                </td>\n                <td class=\"wd-15\" *ngIf=\"app.leave_type == 'ml'\">\n                  <span :matTooltip=\"{{app.leave_reason}}\">Materinity Leave</span>\n                </td> -->\n                <td class=\"wd-16\">{{app.date_from}}-{{app.date_to}}</td>\n                <td class=\"wd-16\">{{app.date_of_apply}}</td>\n                <td class=\"modify\">\n                  <i class=\"fa fa-pencil-square-o\" aria-hidden=\"true\" (click)=\"appEdit(app.application_id, app.ID_code)\"></i>\n                  <i class=\"fa fa-check\" aria-hidden=\"true\" (click)=\"appAccept(app.application_id, app.ID_code)\"></i>\n                  <i class=\"fa fa-times\" aria-hidden=\"true\" (click)=\"appCancel(app.application_id, app.ID_code)\"></i>\n                  <mat-icon class=\"mat-icon material-icons pos-rel\" role=\"img\" aria-hidden=\"true\">more_vert</mat-icon>\n                </td>\n              </tr>\n            </tbody>\n          </table>\n        </div>\n      </mat-tab>\n      <mat-tab label=\"Approved Applications\">\n        <div class=\"col-sm-12 bg-white pt-3 pb-2 d-inline-block rad-box\">\n          <table id=\"table_approve\" class=\"table table-striped\" cellspacing=\"0\" width=\"100%\">\n            <thead>\n              <tr>\n                <th class=\"wd-12\">Application ID</th>\n                <th class=\"wd-16\">Employee name</th>\n                <th class=\"wd-15\">QCI/Board</th>\n                <th class=\"wd-15\">Leave Type</th>\n                <th class=\"wd-16\">Date Applied</th>\n                <th class=\"wd-16\">Application Date</th>\n                <th class=\"modify\">Actions</th>\n              </tr>\n            </thead>\n            <tbody>\n              <tr *ngFor=\"let approve of approvedLeave | reverse | filter : term; let i = index;\">\n                <td class=\"wd-7\">\n                  <a href=\"javascript:void(0)\" class=\"text-primary\" (click)=\"appInfo(approve.application_id, approve.ID_code)\">\n                    <u>{{approve.application_id | slice:0:12 }}</u>\n                  </a>\n                </td>\n                <td class=\"wd-16\">\n                  <span :matTooltip=\"{{approve.email}}\">{{approve.Officials}}</span>\n                </td>\n                <td class=\"wd-15\">\n                  <span :matTooltip=\"{{approve['QCI/Board']}}\">{{approve['QCI/Board']}}</span>\n                </td>\n                <td class=\"wd-15\">{{approve.leave_type}}</td>\n                <!-- <td class=\"wd-15\" *ngIf=\"approve.leave_type == 'ptl'\">\n                  <span :matTooltip=\"{{approve.leave_reason}}\">Paterinity Leave</span>\n                </td>\n                <td class=\"wd-15\" *ngIf=\"approve.leave_type == 'cl'\">\n                  <span :matTooltip=\"{{approve.leave_reason}}\">Casual Leave</span>\n                </td>\n                <td class=\"wd-15\" *ngIf=\"approve.leave_type == 'pl'\">\n                  <span :matTooltip=\"{{approve.leave_reason}}\">Privileged Leave</span>\n                </td>\n                <td class=\"wd-15\" *ngIf=\"approve.leave_type == 'sl'\">\n                  <span :matTooltip=\"{{approve.leave_reason}}\">Sick Leave</span>\n                </td>\n                <td class=\"wd-15\" *ngIf=\"approve.leave_type == 'eol'\">\n                  <span :matTooltip=\"{{approve.leave_reason}}\">Extra Ordinary Leave</span>\n                </td>\n                <td class=\"wd-15\" *ngIf=\"approve.leave_type == 'ml'\">\n                  <span :matTooltip=\"{{approve.leave_reason}}\">Materinity Leave</span>\n                </td> -->\n                <td class=\"wd-16\">{{approve.date_from}}-{{approve.date_to}}</td>\n                <td class=\"wd-16\">{{approve.date_of_apply}}</td>\n                <td class=\"modify\">\n                  <small>No Actions</small>\n                  <!-- <i class=\"fa fa-pencil-square-o\" aria-hidden=\"true\" (click)=\"appEdit(approve.application_id, approve.qci_id)\"></i>\n                  <i class=\"fa fa-check\" aria-hidden=\"true\" (click)=\"appAccept(approve.application_id, approve.qci_id)\"></i>\n                  <i class=\"fa fa-times\" aria-hidden=\"true\" (click)=\"appCancel(approve.application_id, approve.qci_id)\"></i>\n                  <mat-icon class=\"mat-icon material-icons pos-rel\" role=\"img\" aria-hidden=\"true\">more_vert</mat-icon> -->\n                </td>\n              </tr>\n            </tbody>\n          </table>\n        </div>\n      </mat-tab>\n      <mat-tab label=\"Cancelled Applications\">\n        <div class=\"col-sm-12 bg-white pt-3 pb-2 d-inline-block rad-box\">\n          <table id=\"table_cancel\" class=\"table table-striped\" cellspacing=\"0\" width=\"100%\">\n            <thead>\n              <tr>\n                <th class=\"wd-12\">Application ID</th>\n                <th class=\"wd-16\">Employee name</th>\n                <th class=\"wd-15\">QCI/Board</th>\n                <th class=\"wd-15\">Leave Type</th>\n                <th class=\"wd-16\">Date Applied</th>\n                <th class=\"wd-16\">Application Date</th>\n                <th class=\"modify\">Actions</th>\n              </tr>\n            </thead>\n            <tbody>\n              <tr *ngFor=\"let cancel of cancelledLeave | reverse | filter : term; let i = index;\">\n                <td class=\"wd-7\">\n                  <a href=\"javascript:void(0)\" class=\"text-primary\" (click)=\"appInfo(cancel.application_id, cancel.ID_code)\">\n                    <u>{{cancel.application_id | slice:0:12 }}</u>\n                  </a>\n                </td>\n                <td class=\"wd-16\">\n                  <span :matTooltip=\"{{cancel.email}}\">{{cancel.Officials}}</span>\n                </td>\n                <td class=\"wd-15\">\n                  <span :matTooltip=\"{{cancel['QCI/Board']}}\">{{cancel['QCI/Board']}}</span>\n                </td>\n                <td class=\"wd-15\">{{cancel['leave_type']}}</td>\n                <!-- \n                <td class=\"wd-15\" *ngIf=\"cancel.leave_type == 'ptl'\">\n                  <span :matTooltip=\"{{cancel.leave_reason}}\">Paterinity Leave</span>\n                </td>\n                <td class=\"wd-15\" *ngIf=\"cancel.leave_type == 'cl'\">\n                  <span :matTooltip=\"{{cancel.leave_reason}}\">Casual Leave</span>\n                </td>\n                <td class=\"wd-15\" *ngIf=\"cancel.leave_type == 'pl'\">\n                  <span :matTooltip=\"{{cancel.leave_reason}}\">Privileged Leave</span>\n                </td>\n                <td class=\"wd-15\" *ngIf=\"cancel.leave_type == 'sl'\">\n                  <span :matTooltip=\"{{cancel.leave_reason}}\">Sick Leave</span>\n                </td>\n                <td class=\"wd-15\" *ngIf=\"cancel.leave_type == 'eol'\">\n                  <span :matTooltip=\"{{cancel.leave_reason}}\">Extra Ordinary Leave</span>\n                </td>\n                <td class=\"wd-15\" *ngIf=\"cancel.leave_type == 'ml'\">\n                  <span :matTooltip=\"{{cancel.leave_reason}}\">Materinity Leave</span>\n                </td> -->\n                <td class=\"wd-16\">{{cancel.date_from}}-{{cancel.date_to}}</td>\n                <td class=\"wd-16\">{{cancel.date_of_apply}}</td>\n                <td class=\"modify\">\n                  <small>No Actions</small>\n                  <!-- <i class=\"fa fa-pencil-square-o\" aria-hidden=\"true\" (click)=\"appEdit(cancel.application_id, cancel.qci_id)\"></i>\n                  <i class=\"fa fa-check\" aria-hidden=\"true\" (click)=\"appAccept(cancel.application_id, cancel.qci_id)\"></i>\n                  <i class=\"fa fa-times\" aria-hidden=\"true\" (click)=\"appCancel(cancel.application_id, cancel.qci_id)\"></i>\n                  <mat-icon class=\"mat-icon material-icons pos-rel\" role=\"img\" aria-hidden=\"true\">more_vert</mat-icon> -->\n                </td>\n              </tr>\n            </tbody>\n          </table>\n        </div>\n      </mat-tab>\n    </mat-tab-group>\n  </div>\n</div>\n"
...
/***/ "./src/app/main/newapp/newapp.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var NewappComponent = /** @class */ (function () {
    ...
    NewappComponent.prototype.ngOnInit = function () {
        this.api.getEOL();
        this.api.approvedLeave();
        this.api.cancelledLeave();
    };
    // simplyfy Response from all http request
    NewappComponent.prototype.simplyfiData = function () {
        var _this = this;
    ...
    NewappComponent.prototype.appInfo = function (application_id, qci_id) {
        localStorage.setItem('ID_code', qci_id);
        var event = 'info';
        this.openApplicationModal(application_id, event);
    };
    NewappComponent.prototype.appAccept = function (application_id, qci_id) {
        localStorage.setItem('ID_code', qci_id);
        var event = 'accept';
        this.openApplicationModal(application_id, event);
    };
    NewappComponent.prototype.appEdit = function (application_id, qci_id) {
        localStorage.setItem('ID_code', qci_id);
        var event = 'edit';
        this.openApplicationModal(application_id, event);
    };
    NewappComponent.prototype.appCancel = function (application_id, qci_id) {
        localStorage.setItem('ID_code', qci_id);
        var event = 'decline';
        this.openApplicationModal(application_id, event);
    };
    ...
    // accept leave application
    NewappComponent.prototype.acceptApp = function (app_id, qci_id) {
        this.dis = true;
        this.spnnr = true;
        var date = new Date(), latest_date = this.datepipe.transform(date, 'dd/MM/yyyy'), tmp = { application_id: app_id, qci_id: qci_id, date_reviewed: latest_date };
        this.api.leaveForApproval(tmp);
...
/***/ "./src/app/main/servererr/servererr.component.html":
/***/ (function(module, exports) {
...
/***/ "./src/app/main/servererr/servererr.component.scss":
/***/ (function(module, exports) {
...
/***/ "./src/app/main/servererr/servererr.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ServererrComponent = /** @class */ (function () {
    ...
    ServererrComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            ...
            template: __webpack_require__("./src/app/main/servererr/servererr.component.html"),
            styles: [__webpack_require__("./src/app/main/servererr/servererr.component.scss")]
        }),
...
/***/ "./src/app/main/stat/stat.component.html":
/***/ (function(module, exports) {
...
/***/ "./src/app/main/stat/stat.component.scss":
/***/ (function(module, exports) {
...
/***/ "./src/app/main/stat/stat.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var StatComponent = /** @class */ (function () {
    ...
    StatComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-stat',
            template: __webpack_require__("./src/app/main/stat/stat.component.html"),
            styles: [__webpack_require__("./src/app/main/stat/stat.component.scss")]
        }),
        __metadata("design:paramtypes", [])
    ], StatComponent);
...
var ApiService = /** @class */ (function () {
    function ApiService(snackBar, http, router, httpClient) {
        this.snackBar = snackBar;
        this.http = http;
        this.router = router;
    ...
    ApiService.prototype.login = function (uname, pwd) {
        var _this = this;
        this.uid = uname;
        var tmp = { email: uname, password: pwd };
        var data = JSON.stringify(tmp);
        return new Promise(function (resolve) {
            _this.http.post(_this.URL + 'lms/loginAdmin', data)
    ...
    // CSV Upload
    ApiService.prototype.upload = function (files) {
        var _this = this;
        ...
        files.forEach(function (file) {
            ...
            var req = new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpRequest */]('POST', _this.URL + 'lms/holiday', formData, {
                reportProgress: true
            });
            var progress = new __WEBPACK_IMPORTED_MODULE_4_rxjs_Subject__["a" /* Subject */]();
            _this.httpClient.request(req).subscribe(function (event) {
    ...
    ApiService.prototype.uploadEmployee = function (files) {
        var _this = this;
        // create a const to capture/record status of file
        var status = {};
        // for each files
        files.forEach(function (file) {
            var formData = new FormData();
            formData.append('file', file, file.name);
            var req = new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpRequest */]('POST', _this.URL + 'lms/addPEmp', formData, {
                reportProgress: true
            });
            var progress = new __WEBPACK_IMPORTED_MODULE_4_rxjs_Subject__["a" /* Subject */]();
            _this.httpClient.request(req).subscribe(function (event) {
    ...
    ApiService.prototype.GetEmployeeDetails = function () {
        return this.http.get(this.URL + 'lms/employeeDetails', this.opts).map(function (r) { return r.json(); });
    };
    // Get QCI Employee from CSV
    ApiService.prototype.getEmployeeCSV = function () {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.get(_this.URL + 'lms/addPEmp', _this.opts) // lms/upload
                .map(function (res) { return res.json(); })
                .subscribe(function (response) {
                if (response.success) {
    ...
    ApiService.prototype.getEmployee = function (data) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.get(_this.URL + 'lms/addEmployee/' + data, _this.opts)
                .map(function (res) { return res.json(); })
                .subscribe(function (response) {
                if (response.success)
    ...
    // get employee leaves
    ApiService.prototype.myLeaves = function (data) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.get(_this.URL + 'lms/applyLeave/' + data, _this.opts)
                .map(function (res) { return res.json(); })
                .subscribe(function (response) {
                if (response.success)
            ...
            _this.http.get(_this.URL + 'lms/input', _this.opts)
                ...
                if (response.success) {
                    if (response.data.length > 0)
                        _this.emitEOL.emit(response.data);
                    else
            ...
            _this.http.get(_this.URL + 'lms/holiday', _this.opts)
                ...
                if (response.success) {
                    if (response.result.length == 0)
                        console.log("No holiday file uploaded yet !");
                    else
    ...
    // leaveModified( ){}
    ApiService.prototype.leaveModified = function (data) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.post(_this.URL + 'lms/api', data, _this.opts)
                .map(function (res) { return res.json(); })
                .subscribe(function (response) {
                if (response.success) {
                    _this.emitMyApplication.emit(response);
                    _this.snackBars("Application modified", "Successfully");
                    // does not refresh after response
                }
                else
                    _this.snackBars("Api", response.success);
                resolve(true);
            }, function (err) { return _this.router.navigate(['/404']); });
        });
    };
    ...
    ApiService.prototype.postEOLBSDate = function (data) {
        var _this = this;
        var tmp = { dates: data };
        return new Promise(function (resolve) {
            _this.http.post(_this.URL + 'lms/count', tmp, _this.opts)
                .map(function (res) { return res.json(); })
                .subscribe(function (response) {
                if (response.success) {
                    ...
                    return false; //this.snackBars(response.message, response.success)
                resolve(true);
            }, function (err) { return _this.router.navigate(['/404']); });
        });
    };
    ApiService.prototype.getEmpOnLeave = function (data) {
        var _this = this;
        var tmp = { date: data };
        return new Promise(function (resolve) {
        ...
        return new Promise(function (resolve) {
            _this.http.post(_this.URL + 'lms/editEmployeeDetails', data, _this.opts)
                ...
                if (response.success) {
                    ...
                    _this.snackBars("Edit Employee Details", "response.success");
                resolve(true);
            }, function (err) { return _this.router.navigate(['/404']); });
        });
    };
    ...
    ApiService.prototype.deleteEmp = function (data) {
        ...
        return new Promise(function (resolve) {
            _this.http.post(_this.URL + 'lms/deleteEmployee', JSON.stringify(data), _this.opts)
                ...
                .subscribe(function (response) {
                if (response.success) {
                    _this.snackBars("Alert:", "Employee deleted Successfully!");
                }
                else
                    _this.snackBars("Alert:", "Employee not deleted");
                resolve(true);
            }, function (err) { return _this.router.navigate(['/404']); });
        });
    };
...
/***/ "./src/app/services/lms.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    LmsService.prototype.getEmployees = function () {
        ...
        this.api.GetEmployeeDetails().subscribe(function (el) {
            if (el.success)
                ...
                _this.snackBars('Employee Details', 'Try again!');
        }, function (err) { return _this.router.navigate(['/404']); });
    };
