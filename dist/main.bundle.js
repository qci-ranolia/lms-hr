...
var routes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_3__main_nav_nav_component__["a" /* NavComponent */], children: [
            ...
            { path: 'employee-section', component: __WEBPACK_IMPORTED_MODULE_9__main_newapp_newapp_component__["a" /* NewappComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_11__services_auth_service__["a" /* AuthService */]] },
            { path: 'application-status', component: __WEBPACK_IMPORTED_MODULE_8__main_eol_eol_component__["a" /* EolComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_11__services_auth_service__["a" /* AuthService */]] },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__auth0_angular_jwt__ = __webpack_require__("./node_modules/@auth0/angular-jwt/index.js");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["K" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_27_ngx_pipes__["a" /* NgPipesModule */],
                ...
                __WEBPACK_IMPORTED_MODULE_26__auth0_angular_jwt__["a" /* JwtModule */].forRoot({
                    config: {
...
module.exports = "<div class=\"col-sm-12 p-0\">\n    <div class=\"col-sm-12 float-left\">\n        <h5 class=\"d-inline-block\">Employee's List</h5>\n        <div class=\"d-inline-block float-right\">\n            <button mat-button class=\"btn btn-primary p-2 mat-button mt-0 mb-3\" [routerLink]=\"['/add-employee']\">Add Employee</button>\n        </div>\n        <div class=\"col-sm-12 bg-white pt-3 pb-2 d-inline-block rad-box\">\n            <table id=\"table_id\" class=\"table table-striped\" cellspacing=\"0\" width=\"100%\">\n                <thead>\n                    <tr>\n                        <th class=\"wd-7\">QCID</th>\n                        <th class=\"wd-16\">Employee name</th>\n                        <th class=\"wd-7\">Gender</th>\n                        <th class=\"wd-10\">Designation</th>\n                        <th class=\"wd-7\">Board</th>\n                        <th class=\"wd-\">Leave details</th>\n                        <th class=\"modify\">Modify</th>\n                    </tr>\n                </thead>\n                <tbody>\n                    <tr *ngFor=\"let emp of employee; let i = index\">\n                        <td class=\"wd-7\">{{ emp.qci_id }}</td>\n                        <td class=\"wd-16\"><span :matTooltip=\"{{ emp.email }}\">{{ emp.name }}</span></td>\n                        <td class=\"wd-7\">{{ emp.gender }}</td>\n                        <td class=\"wd-10\">{{ emp.designation }}<br /><small>{{ emp.type_of_employee }}</small></td>\n                        <td class=\"wd-7\">{{ emp.board }}</td>\n                        <td class=\"wd-\">\n                            <mat-chip-list>\n                                <mat-chip class=\"bg-light rad-box\"><span matTooltip=\"Casual Leave\">CL: {{ emp.bal_cl }}</span></mat-chip>\n                                <mat-chip class=\"bg-light rad-box\"><span matTooltip=\"Sick Leave\">SL: {{ emp.bal_sl }}</span></mat-chip>\n                                <mat-chip class=\"bg-light rad-box\"><span matTooltip=\"Privileged Leave\">PL: {{ emp.bal_pl }}</span></mat-chip>\n                                <mat-chip class=\"bg-light rad-box\" *ngIf=\"emp.gender == 'Female'\"><span matTooltip=\"Materinity Leave\">ML: {{ emp.bal_ml }}</span></mat-chip>\n                                <mat-chip class=\"bg-light rad-box\" *ngIf=\"emp.gender == 'Male'\"><span matTooltip=\"Paterinity Leave\">PTL: {{ emp.bal_ptl }}</span></mat-chip>\n                                <mat-chip class=\"bg-light rad-box\"><span matTooltip=\"Extraordinary Leave\">EOL: {{ emp.bal_eol }}</span></mat-chip>\n                            </mat-chip-list>                                  \n                        </td>\n                        <td class=\"modify\">\n                            <button mat-button class=\"btn btn-info p-1\" :routerLink=\"/employee-list/{{emp.qci_id}}\">Edit</button>\n                            <button mat-button class=\"ml-2 btn btn-danger p-1\" (click)=\"deleteEmp(emp.qci_id)\">Delete</button>\n                        </td>\n                    </tr>\n                </tbody>\n            </table>\n        </div>\n    </div>\n</div> "
...
var EditEmpComponent = /** @class */ (function () {
    function EditEmpComponent(route, router, lms) {
        var _this = this;
        this.route = route;
        this.router = router;
        this.lms = lms;
    ...
    EditEmpComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */], __WEBPACK_IMPORTED_MODULE_2__services_lms_service__["a" /* LmsService */]])
    ], EditEmpComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__dialog_dialog_component__ = __webpack_require__("./src/app/main/dashboard/dialog/dialog.component.ts");
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(dialog, api, lms, httpClient) {
        var _this = this;
        this.dialog = dialog;
        this.api = api;
        this.lms = lms;
        ...
        this.unsubEmpOnLeaveTwo = this.lms.emitEmpOnLeave.subscribe(function (r) { return (_this.emp = r); });
        ...
        this.unsubCount = this.lms.emitCount.subscribe(function (r) {
    ...
    DashboardComponent.prototype.todayCheck = function (day) {
        if (!day)
            return false;
        return __WEBPACK_IMPORTED_MODULE_3_moment__().format("L") === day.format;
    };
    DashboardComponent.prototype.createCalendar = function (month) {
        var _this = this;
        var f = __WEBPACK_IMPORTED_MODULE_3_moment__(month).startOf("M"), s = __WEBPACK_IMPORTED_MODULE_3_moment__(f).endOf("month"), sunday = 0, r = [], c = f.clone(), h = [], z = [], y, m, temp = [], dates = [];
        ...
        setTimeout(function () {
            ...
            _this.lms.postEOLBSDate(_this.workingDays);
        ...
        var days = Array.apply(null, { length: month.daysInMonth() })
            ...
            .map(function (n) {
            return __WEBPACK_IMPORTED_MODULE_3_moment__(f)
                .add(n, "d")
                .format("DD");
        });
    ...
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_material__["h" /* MatDialog */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__services_lms_service__["a" /* LmsService */],
...
module.exports = "<!-- <div class=\"col-sm-12 p-0\">\n    <div class=\"col-sm-12 float-left\">\n        <h5 class=\"d-inline-block\">Employee's List</h5>\n        <div class=\"col-sm-12 bg-white pt-3 pb-2 d-inline-block rad-box\">\n            <table id=\"table_id\" class=\"table table-striped\" cellspacing=\"0\" width=\"100%\">\n                <thead>\n                    <tr>\n                        <th class=\"wd-7\">QCID</th>\n                        <th class=\"wd-16\">Employee name</th>\n                        <th class=\"wd-7\">Email</th>\n                        <th class=\"wd-7\">Gender</th>\n                        <th class=\"wd-10\">Designation</th>\n                        <th class=\"wd-7\">Board</th>\n                        <th class=\"wd-\">Date</th>\n                    </tr>\n                </thead>\n                <tbody>\n                    <tr>\n                        <td class=\"wd-7\">emp.qci_id</td>\n                        <td class=\"wd-16\">emp.name</td>\n                        <th class=\"wd-7\">emp.email</th>\n                        <td class=\"wd-7\">emp.gender</td>\n                        <td class=\"wd-10\">emp.designation<br /><small>emp.type_of_employee</small></td>\n                        <td class=\"wd-7\">emp.board</td>\n                        <td class=\"wd-\">\n                            <mat-chip-list>\n                                <mat-chip><span matTooltip=\"Casual Leave\">CL: emp.bal_cl</span></mat-chip>\n                                <mat-chip><span matTooltip=\"Sick Leave\">SL: emp.bal_sl</span></mat-chip>\n                                <mat-chip><span matTooltip=\"Privileged Leave\">PL: emp.bal_pl</span></mat-chip>\n                                <mat-chip><span matTooltip=\"Materinity Leave\">ML: emp.bal_ml</span></mat-chip>\n                                <mat-chip><span matTooltip=\"Paterinity Leave\">PTL: emp.bal_ptl</span></mat-chip>\n                                <mat-chip><span matTooltip=\"Extraordinary Leave\">EOL: emp.bal_eol</span></mat-chip>\n                            </mat-chip-list>                                  \n                        </td>\n                    </tr>\n                </tbody>\n            </table>\n        </div>\n    </div>\n</div>-->"
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.upload = function (files) {
        ...
        files.forEach(function (file) {
            ...
            var req = new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["e" /* HttpRequest */]('POST', _this.URL + 'lms/holiday', formData, {
                reportProgress: true
            });
    ...
    ApiService.prototype.declineLeave = function (data) {
        return this.http.post(this.URL + 'lms/declineLeave', data, this.opts).map(function (r) { return r.json(); });
    };
    // Post month dates to get employee on leave in a month
    ApiService.prototype.postEOLBSDate = function (data) {
        var tmp = { dates: data };
        return this.http.post(this.URL + 'lms/count', tmp, this.opts).map(function (r) { return r.json(); });
    };
    ApiService.prototype.getEmpOnLeave = function (data) {
        var tmp = { date: data };
        return this.http.post(this.URL + 'lms/empOnLeave', tmp, this.opts).map(function (r) { return r.json(); });
    };
...
var LmsService = /** @class */ (function () {
    function LmsService(api, router, snackBar, httpClient) {
        this.api = api;
        this.router = router;
        this.snackBar = snackBar;
        this.httpClient = httpClient;
    ...
    LmsService.prototype.declineLeave = function (tmp) {
        var _this = this;
        this.api.declineLeave(tmp).subscribe(function (el) {
            if (el.success) {
                // this.getEOL()
                // this.approvedLeave()
                // this.cancelledLeave()
                _this.emitMyApplication.emit(el);
            }
            else
                _this.snackBars(el.error, el.success);
        }, function (err) { return _this.router.navigate(['/404']); });
    };
    ...
    LmsService.prototype.getEmpOnLeave = function (temp) {
        var _this = this;
        this.api.getEmpOnLeave(temp).subscribe(function (el) {
            if (el.success)
                _this.emitEmpOnLeave.emit(el.data);
            else
                _this.snackBars(el.message, el.success);
        }, function (err) { return _this.router.navigate(['/404']); });
    };
    ...
    LmsService.prototype.postEOLBSDate = function (data) {
        var _this = this;
        this.api.postEOLBSDate(data).subscribe(function (el) {
            console.log(el);
            if (el.success)
    ...
    LmsService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__api_service__["a" /* ApiService */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */], __WEBPACK_IMPORTED_MODULE_3__angular_material__["A" /* MatSnackBar */], __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["b" /* HttpClient */]])
    ], LmsService);
    return LmsService;
}());
