...
var AppinfoComponent = /** @class */ (function () {
    ...
    AppinfoComponent = __decorate([
        ...
        __metadata("design:paramtypes", [Object, __WEBPACK_IMPORTED_MODULE_5__angular_common__["d" /* DatePipe */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__services_lms_service__["a" /* LmsService */],
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.uploadEmployee = function (files) {
        ...
        files.forEach(function (file) {
            var formData = new FormData();
            formData.append('file', file, file.name);
            var req = new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpRequest */]('POST', _this.URL + 'lms/upload', formData, {
                reportProgress: true
            });
            var progress = new __WEBPACK_IMPORTED_MODULE_4_rxjs_Subject__["a" /* Subject */]();
            _this.httpClient.request(req).subscribe(function (event) {
    ...
    ApiService.prototype.getEmployeeCSV = function () {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.get(_this.URL + 'lms/upload', _this.opts)
                .map(function (res) { return res.json(); })
                .subscribe(function (response) {
                if (response.success) {
